...
const MONGO_URL = MONGO_URI ? MONGO_URI : `mongodb://${MONGO_HOSTNAME}:${MONGO_PORT}/${MONGO_DB}`;
...
mongoose
  ...
  .then(() => {
    ...
    Calendar.find({ user_id: 'system', name: 'IN Holidays' })
      .countDocuments()
      .exec(function (err, count) {
        ...
        if (count === 0) {
          ...
          console.log('Created IN Holidays calendar.');
        }
      });
  })
  .catch((e) => {
